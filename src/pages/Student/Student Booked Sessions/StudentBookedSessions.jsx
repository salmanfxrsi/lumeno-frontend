...
import StudentBookedSessionsCard from "./StudentBookedSessionsCard";
...
const StudentManageNotes = () => {
  ...
  return (
    <div className="w-11/12 3xl:container mx-auto">
      <Helmet>
        <title>Booked Sessions | Lumeno Student</title>
      </Helmet>
      {/* Manage Notes Header  */}
