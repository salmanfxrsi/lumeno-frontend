...
const Register = () => {
  ...
  return (
    <div className="hero py-4 lg:py-36">
      <Helmet>
        ...
        <div className="card w-full max-w-2xl shrink-0">
          ...
          >
            ...
            <div className="form-control mt-2">
              <button
                type="submit"
                className="flex justify-center items-center gap-2 bg-[#ABEF5F] font-black uppercase px-5 py-3 text-sm text-black transition-colors duration-300 transform rounded-md lg:w-auto hover:bg-gray-500 focus:outline-none"
              >
                <h1>Register Now</h1>
