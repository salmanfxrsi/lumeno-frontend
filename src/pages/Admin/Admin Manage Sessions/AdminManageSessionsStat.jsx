...
const AdminManageSessionsStat = ({ sessions, pending, approved, rejected }) => {
  return (
    <div className="stats w-full my-12">
      ...
      <div className="stat">
        ...
        <div className="font-bold uppercase">Total Sessions</div>
...
AdminManageSessionsStat.propTypes = {
...
export default AdminManageSessionsStat;
